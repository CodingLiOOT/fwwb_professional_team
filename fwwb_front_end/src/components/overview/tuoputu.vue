  ...
  methods: {
    drawFly(ctx,p0,p1,p2){
      ...
      function createGradient(ctx,p0,p1){
        ...
        grd.addColorStop(0,'rgba(255,252,252,0.02)');
    ...
    flying(){
      ...
      let p0={'x':this.siteInfo[3][20].x,'y':this.siteInfo[3][20].y};
      let p2={'x':this.siteInfo[11][16].x,'y':this.siteInfo[11][16].y};
      let p1={'x':this.siteInfo[3][20].x-50,'y':this.siteInfo[3][20].y+30};
      // this.drawFly(ctx,p0,p1,p2);

      p0={'x':this.siteInfo[1][2].x,'y':this.siteInfo[1][2].y};
      p2={'x':this.siteInfo[11][11].x,'y':this.siteInfo[11][11].y};
      p1={'x':this.siteInfo[1][2].x+50,'y':this.siteInfo[1][2].y+5};
      this.drawFly(ctx,p0,p1,p2);
      //
      p0={'x':this.siteInfo[10][4].x,'y':this.siteInfo[10][4].y};
      p2={'x':this.siteInfo[11][21].x,'y':this.siteInfo[11][21].y};
      p1={'x':this.siteInfo[10][4].x+100,'y':this.siteInfo[10][4].y+100};
      this.drawFly(ctx,p0,p1,p2);
      //
      p0={'x':this.siteInfo[10][4].x,'y':this.siteInfo[10][4].y};
      p2={'x':this.siteInfo[10][10].x,'y':this.siteInfo[10][10].y};
      p1={'x':this.siteInfo[10][4].x-50,'y':this.siteInfo[10][4].y+100};
      this.drawFly(ctx,p0,p1,p2);
      //
      p0={'x':this.siteInfo[3][20].x,'y':this.siteInfo[3][20].y};
      p2={'x':this.siteInfo[3][14].x,'y':this.siteInfo[3][14].y};
      p1={'x':this.siteInfo[3][20].x+100,'y':this.siteInfo[3][20].y+200};
      this.drawFly(ctx,p0,p1,p2);
      //
      p0={'x':this.siteInfo[1][11].x,'y':this.siteInfo[1][11].y};
      p2={'x':this.siteInfo[12][15].x,'y':this.siteInfo[12][15].y};
      p1={'x':this.siteInfo[1][11].x+80,'y':this.siteInfo[1][11].y+20};
      this.drawFly(ctx,p0,p1,p2);

      p0={'x':this.siteInfo[5][3].x,'y':this.siteInfo[5][3].y};
      p2={'x':this.siteInfo[3][19].x,'y':this.siteInfo[3][19].y};
      p1={'x':this.siteInfo[5][3].x+80,'y':this.siteInfo[5][3].y+20};
      this.drawFly(ctx,p0,p1,p2);
